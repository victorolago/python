# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 09:30:29 2017
...
os.chdir('M:\\Projects\\Data Cleaning\\Python\\data\\HIV') 
#Reading the Raw_hiv_data dataset
dfA = pd.read_csv('gauteng.csv', sep='	', encoding='utf-8') #Take note of the csv columns separation
#deleting dummy ID
del dfA['dummy_id']
...
#Cleaning some names
#removing anonymous, twins, abandoned etc upfront
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONYNOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANAONYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONIMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONAMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANOMYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONOMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONOYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONNYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANNONYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONUMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONYMOS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONYNOMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANANYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANYNOMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'UNONYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'TWI')] 
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'SAMPLE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDON')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABONDONED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABONDNED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABONDENED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDORED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABADONED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANONED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDONDED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDONEN')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDONNED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'UNKNOWN')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOTHER TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOTHER OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BABY OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BABY TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'HIV')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NHLS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'STUDY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FEMALE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MALE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NO NAME')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FATHER TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FATHER OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOM TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MUM TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOM OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MUM OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'AMPATH')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CHILD OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CHILD TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(' ')$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NO PATIENT')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'TRIPLET')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'HEALTH')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'HOSPITAL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'WRITTING')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'SURVEY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'X-RAY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BLOOD')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PROGRAMME')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'HUSBAND')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MAN TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PARTNER')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BABAY TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'UNREADABLE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'WIFE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'EMERGERNCY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BBY OF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NO DETAILS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'SURNAME')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'VCT')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CDC')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FOR ADOPTION')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CLASSIFIED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CONFIDENTIAL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CONNFIDENTIAL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'UNIDENTIFIED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CL ASSIFIED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NEEDLE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOTHOR TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOTH TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NOT STATED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'DADY TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'DADDY TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(MOTHER)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(FATHER)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'U NKNOWN')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PROJECT')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'EQA')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'HOMOTRANSPLANTAAT')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'VIROLOGY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PROGRAM')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PCR')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'HOMOTRANSPLANT')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PROGRA')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'PATIENT NO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'RC NO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'DAD TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MOTHE TO')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'INJURY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'DETAILS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CDC POS CONTROL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CREATED BY MISTAKE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANSUR')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ABANDANED')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'AGINCOURT')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'EMERGENCY')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'TRIAL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'STAFF CASE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'MMMR')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FOR CONFIRMATION')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FOR COMFIRMATION')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ILLEGIBLE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'AMONYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONYMOUR')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'UNKWOWN')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'UNKWOW')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANONYMUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'ANOYMOUS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BABY A')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'BABY B')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'CONTROL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'DISEASES')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'SERVICES')] 
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'EXTERNAL')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'NO PATEINTS')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'FAIRGREEN COUFESSES AVENUE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'N.C.T')]

#Stripping the patient_name_lis - first strip
...
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(M/T)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(MT)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(BO)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(B/O)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'B/O,')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'B/T,')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r',B T ')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r',B O ')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r',M T ')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r',M TO ')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r',B TO ')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(BT)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(BT )')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(B TO )')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(B/T)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(MO)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'(M/O)$')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(M/T)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(M/T,)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(BO,)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(B/O )')]
...
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(BT.)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(M/O)')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'1,00 INF')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'THISTLE,CYCLE')]
dfA = dfA[~dfA['patient_name_lis'].astype(str).str.contains(r'^(\w \w \w,\w \w)$')]

##Cleaning some names
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'C HAUKE', 'CHAUKE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'¿', 'E')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M,HANGWANA', 'MHANGWANA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M PYANA', 'MPYANA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ASHIANGWAKO', 'MASHIANGWAKO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SAMSO-N', 'SAMSON')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'UNAM B O', 'UNAMBO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PHUMEZAB O', 'PHUMEZABO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NTOMBIZANELEB O', 'NTOMBIZANELEBO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M,GILANE', 'MGILANE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NT5HABELENG', 'NTSHABELENG')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J0HN', 'JOHN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NOLUTHANDOB O', 'NOLUTHANDOBO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N ASIPHE', 'NASIPHE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N TOMBEKAYA', 'NTOMBEKAYA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M KHULULENI', 'MKHULULENI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ZUKISENI', 'MZUKISENI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ZOLISWA', 'MZOLISWA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N OKWANELE', 'NOKWANELE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'Z IZIPHO', 'ZIZIPHO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'A ZILE', 'AZILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'A MANENZA', 'AMANENZA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'T ABISA', 'TABISA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N OMFUNDISO', 'NOMFUNDISO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N ONKOLISO', 'NONKOLISO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ZOMO', 'MZOMO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'Z INTATHU', 'ZINTATHU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N DOYISILE', 'NDOYISILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ZUVUKILE', 'MZUVUKILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N OLUFEFE', 'NOLUFEFE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B UYISILE', 'BUYISILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N TOMBOXOLO', 'NTOMBOXOLO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'Z INTATHU', 'ZINTATHU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O NESIMO', 'ONESIMO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N OKULUNGA', 'NOKULUNGA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N WABISA', 'NWABISA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'A,VON', 'AVON')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M,AHOLE', 'MAHOLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'-JOYCE', 'JOYCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M OTHABAKGANG', 'MOTHABAKGANG')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'-P', 'P')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M,ATSIMELA', 'MATSIMELA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O NEIL', 'ONEIL')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O RIEN', 'ORIEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'S BONGILE', 'SBONGILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B ABY', 'BABY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M,AHDLA', 'MAHDLA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'RONÃL', 'RONÃL')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VD', 'VAN DER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V.D', 'VAN DER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V,D', 'VAN DER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V/D', 'VAN DER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V D', 'VAN DER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N DLOVU|NDLO VU', 'NDLOVU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V ERONICA', 'VERONICA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HYLLIS', 'PHYLLIS') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P ATIENCES', 'PATIENCE') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HILISIWE', 'PHILISIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'I GNATIA', 'IGNATIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O RLANDO', 'ORLANDO') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N JOKWENI', 'NJOKWENI') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N OSMILO', 'NOSIMILO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'A BRAM', 'ABRAM')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P AULINAH', 'PAULINAH') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'A SINATHI', 'ASINATHI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O RATILE', 'ORATILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P ATRIC', 'PATRIC')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'I NNOCENT', 'INNOCENT')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O SHEA', 'OSHEA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V IOLET', 'VIOLET')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M UMSY', 'MUMSY') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'L WANDLE', 'LWANDLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P RISCILLA', 'PRISCILLA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JU LIA', 'JULIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HILLIP', 'PHILLIP')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PRISC A', 'PRISCA') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V STADEN', 'VAN STADEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V STADAN', 'VAN STADAN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V ROOYEN', 'VAN ROOYEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V CASTLE', 'VAN CASTLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'L1NDY', 'LINDY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MODJADJI3', 'MODJADJI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B8USISIWE', 'BUSISIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V RENSBURG', 'VAN RENSBURG')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B EN', 'BEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'L UPHEKILE', 'LUPHEKILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'AN GEL', 'ANGEL')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'AP RIL', 'APRIL')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'HI LDA', 'HILDA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BU SISIWE', 'BUSISIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VU SI', 'VUSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BRE NDA', 'BRENDA') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BON TLE', 'BONTLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DIN EO', 'DINEO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KAR ABO', 'KARABO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KHO SI', 'KHOSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MON ICA', 'MONICA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SO PHIE', 'SOPHIE') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LY DIA', 'LYDIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LU YANDA', 'LUYANDA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'IN NOCENT', 'INNOCENT')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ELV A', 'ELVA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SI PHIWE', 'SIPHIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NOM SA', 'NOMSA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SIP HESIHLE', 'SIPHESIHLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LIN AH', 'LINAH')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CAL PHONIA', 'CALPHONIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'TH EMBA', 'THEMBA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SI PHO', 'SIPHO') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'TEL AVIV', 'TELAVIV')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'D WAART', 'DE WAART')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V.WYK', 'VAN WYK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V SCHALKWYK', 'VAN SCHALKWYK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V ROOI', 'VAN ROOI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V METZINGER', 'VAN METZINGER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V TONDER', 'VAN TONDER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'OMPHILE2007', 'OMPHILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'POOE,AM,A MATHAPELO', 'POOE,M,MATHAPELO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N KOSI', 'NKOSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ATHE', 'MATHE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P-RINCE', 'PRINCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P ATIENCE', 'PATIENCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V,WYK', 'VAN WYK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PHI RI', 'PHIRI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JAM,JAM', 'JAM JAM')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LU UCY', 'LUCY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'A LICE', 'ALICE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'-ERASMUS', 'ERASMUS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'-MATHUNZI', 'MATHUNZI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V ZYL', 'VAN ZYL')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'V WYK', 'VAN WYK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SIF ISO', 'SIFISO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MB ALI', 'MBALI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN DER,WESTHUIZEN', 'VAN DER WESTHUIZEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'TI BANE', 'TIBANE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PHY LLIS', 'PHYLLIS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LU NGISA', 'LUNGISA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SI MILO', 'SIMILO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ETH EL', 'ETHEL')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ANDISWA8', 'ANDISWA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MABAYI0', 'MABAYIO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MABAS0', 'MABASO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SAR AH', 'SARAH')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MO STAPHER', 'MOSTAPHER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BAB Y', 'BABY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MIM I', 'MIMI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ALIC E', 'ALICE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BONGAN I', 'BONGANI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BOTIHA LE', 'BOTIHALE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CONSTAN CE', 'CONSTANCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CONT ANCE', 'CONSTANCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CRCONSTANCE', 'CONSTANCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PR INCE', 'PRINCE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'EV ELYN', 'EVELYN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MO NEO', 'MONEO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'EP HRAIM', 'EPHRAIM')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BE NJAMIN', 'BENJAMIN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SP HIWE', 'SPHIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'FR ANCINA', 'FRANCINA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'TSHEP O', 'TSHEPO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JOSTIN AH', 'JOSTINAH')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REF ILWE', 'REFILWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JEN EVIEVE', 'JENEVIEVE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'THEMB ISA', 'THEMBISA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VIOL ET', 'VIOLET')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MARTH A', 'MARTHA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SP HIWE', 'SPHIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'FR ANCINA', 'FRANCINA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'TSHEP O', 'TSHEPO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JOSTIN AH', 'JOSTINAH')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REF ILWE', 'REFILWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SIMO N', 'SIMON')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'RAISIB E', 'RAISIBE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REJOIC E', 'REJOICE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'QUENTIN A', 'QUENTINA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ELSI E', 'ELSIE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PRICILL A', 'PRICILLA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SIBUSISIW E', 'SIBUSISIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'FLORA H', 'FLORAH')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'GODFRE Y', 'GODFREY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ZIMKHITH A', 'ZIMKHITHA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REBELL A', 'REBELLA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ZANDIL E', 'ZANDILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LINDOKUHL E', 'LINDOKUHLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NONKULULEK O', 'NONKULULEKO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JESSIC A', 'JESSICA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DINE O', 'DINEO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'IREN E', 'IRENE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SONT O', 'SONTO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ZIKHON A', 'ZIKHONA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'YVONN E', 'YVONNE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SOPHI A', 'SOPHIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PATRIC K', 'PATRICK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REBECC A', 'REBECCA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HAO', 'PHAO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ROSIN A', 'ROSINA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LISBO N', 'LISBON')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BUSISIW E', 'BUSISIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JOHANNA H', 'JOHANNAH')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M AKGALE', 'MAKGALE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M OTLANA', 'MOTLANA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B ALOYI', 'BALOYI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M UTASA', 'MUTASA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ENI', 'MENI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ALAPE', 'MALAPE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ANGWELE', 'MANGWELE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ALINDI', 'MALINDI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M BULI', 'MBULI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M OTETE', 'MOTETE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ASHALA', 'MASHALA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B USAKWA', 'BUSAKWA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M INISI', 'MINISI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M AHLANGU', 'MAHLANGU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B ISSE', 'BISSE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'B ANDA', 'BANDA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HAKOE', 'PHAKOE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J VAN', 'JANSE VAN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J V VUUREN', 'JANSE VAN VUUREN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J/V', 'JANSE VAN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J.V', 'JANSE VAN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J VAN', 'JANSE VAN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'Ã', 'A')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'Â', 'A')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'( \w)$', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'(,\d+)$', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(EM\d+,)', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(\w\d+)', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(\d+,)', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(\w,)', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DAVAN DER', 'DAVANDER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DAVAN,DER', 'DAVANDER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P0RTIA', 'PORTIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'0SMOKLA', 'SMOKLA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'K0METSI', 'KOMETSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KEDI9BONE', 'KEDIBONE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'0MELMIA', 'OMELMIA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DE4 BRUIN', 'DE BRUIN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REVANO9', 'REVANO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SE4NATLE', 'SENATLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ANTH0NY', 'ANTHONY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NONKOSI6', 'NONKOSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CHRIST0PHER', 'CHRISTOPHER')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOLEK0', 'MOLEKO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOKODU8ANE', 'MOKODUANE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SWART2', 'SWART')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MADI9TO', 'MADISTO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CH0EU', 'CHOEU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'THAND0', 'THANDO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN,WYK', 'VAN WYK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'O.BRIEN', 'OBRIEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DE,GAMA', 'DE GAMA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DLAM,INI', 'DLAMINI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN,VUUREN', 'VAN VUUREN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MDUM,NDUM', 'MDUMNDUM')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NTOM,BELA', 'NTOMBELA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MA,PSHE', 'MAPSHE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MA.LIWA', 'MALIWA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M.AHOVE', 'MAHOVE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN,ERE', 'VAN ERE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KHU,ALO', 'KHUMALO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KHUM,ALO', 'KHUMALO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'QU,NTA', 'QUNTA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SE.KANKE', 'SEKANKE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'RWAI,RWAI', 'RWAI RWAI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN,ROOYEN', 'VAN ROOYEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN,NIEKERK', 'VAN NIEKERK')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MZI,KHULU', 'MZIKHULU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MO,GOTSI', 'MOGOTSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MONA,ETSI', 'MONAETSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'PA,ALA', 'PAALA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(\d)', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VAN DER,MERWE', 'VAN DER MERWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LI ZZY', 'LIZZY') 
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DE KOCK', 'DEKOCK')
...
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(DR, )', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'@', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(MS )', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'^(MS,)', '')
...
#Stripping the patient_name_lis - Second strip
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.rstrip(',')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.lstrip(',')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.rstrip('-')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.lstrip('-')
...
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M THOBI', 'MTHOBI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J ULIET', 'JULIET')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ARTHA', 'MARTHA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N TOMBIFUTHI', 'NTOMBIFUTHI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'M ATHILDA', 'MATHILDA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'N CEDO', 'NCEDO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'U ADIVHA', 'UADIVHA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HYLLIS', 'PHYLLIS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'G EORGINA', 'GEORGINA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J VAN', 'JANSE VAN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'Ã', 'A')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'P HALE', 'PHALE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VA N VUUREN', 'VAN VUUREN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SOLOM0N', 'SOLOMON')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'HOOGSTANDER5', 'HOOGSTANDERS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'EM2174678 I,', '')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOL0TLHARE', 'MOLOTLHARE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MO0FEMELA', 'MOOFEMELA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MO0SINKI', 'MOOSINKI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MO0NGAKE', 'MOONGAKE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'JANSE4N', 'JANSEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DESM0ND', 'DESMOND')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MATSHIDIS0', 'MATSHIDISO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOOKETSI3', 'MOOKETSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SWART5S', 'SWARTS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'ROBERT8', 'ROBERT')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'XILONG0', 'XILONGO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'J0LENE', 'JOLENE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOKHAHL0', 'MOKHAHLO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'LUANDR0', 'LUANDRO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'RAP0TU', 'RAPOTU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'T5', 'T')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CATHR0NICA', 'CATHRONICA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'GUGU4', 'GUGU')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'RADEBE 1090', 'RADEBE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'VALOYI MS09282', 'VALOYI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOGOA1', 'MOGOA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NGWENY7A', 'NGWENYA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SITH0LE', 'SITHOLE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SIBONGILE5486', 'SIBONGILE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOKH3ELE', 'MOKHEELE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MOGAN0', 'MOGANO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BO0HATA', 'BOOHATA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MAUREEN,10,15', 'MAUREEN')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MMAKATS1', 'MMAKATSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DINEO3', 'DINEO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'THANDAZ0', 'THANDAZO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'CRESE3NT', 'CRESENT')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'REFILWEABXX3785B', 'REFILWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'D0LLY', 'DOLLY')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'BUSI9HCT', 'BUSI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KENOS1', 'KENOS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'TSHON A', 'TSHONA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'RABOTAP I', 'RABOTAPI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MSIB I', 'MSIBI')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'NTSELE W', 'NTSELEW')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'KAN E', 'KANE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MABEN A', 'MABENA')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SI PHO', 'SIPHO')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'SI PHIWE', 'SIPHIWE')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DE VILLIERS', 'DEVILLIERS')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MC DONALD', 'MCDONALD')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'DE,WET', 'DEWET')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.replace(r'MA.POKANE', 'MAPOKANE')
...
#Stripping the patient_name_lis - third strip
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.rstrip(',')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.lstrip(',')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.rstrip('-')
dfA['patient_name_lis'] = dfA['patient_name_lis'].str.lstrip('-')
...
#keeping the names without numbers and hyphens
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'\d+')]
#despit standing a chance of losing names such as BEN/DAN
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w{1,3})$')]
#names with only two digits
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w,\w)$')]
...
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(QCMD)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w-\w,\w\w)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(ASMSW)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(MSHC)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'NASUR')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'ZAPOOOOO')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'AABB')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'AMSW')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(ABAB)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(ABAN)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(ABLQOOOO)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(ALBURQUEQUE)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'( MT)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'( M T)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'( F T)$')] 
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'( B TO)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'CORPSE')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'SVM')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'LVK,LVK,LVK')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'ENM,ENM,ENM')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'NO,I ID')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'INFORMATION')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'B EQC')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'UNKOWN')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'NEQUAS')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'PRISON')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'FARM')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'IMMUNOTROL')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'TEST')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'PRETORIA')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'BABY A')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'BABY B')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w,\w\w\w)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',BT \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'\w+ BT,')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',MT \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',B T \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',M T \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',B TO \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',M TO \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',FT \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',BO \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',B O \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',CF \w+')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'NO NANE')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r',M T,')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'\w+ M T,')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w-\w)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w-\w,\w-\w,\w-\w)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w\w-\w\w\w)$')]
dfB = dfB[~dfB['patient_name_lis'].astype(str).str.contains(r'^(\w-\w,.,\w-\w)$')]
...
##saving the dataset
dfF.to_csv('pp_gauteng.csv', sep=',', encoding='utf-8')
